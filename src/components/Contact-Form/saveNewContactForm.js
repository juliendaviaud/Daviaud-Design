  ...
  return (
    ...
    >
      ...
      <textarea
        type="textarea"
        name="moreInfos"
        placeholder="Informations sur votre projet"
        onChange={handleChange}
        value={data.moreInfos}/>
      <p ref={validatedMessage} className="validated-message display-none">
        Informations envoyées. <br />
        Je vous remercie, je reviendrais vers vous dans les plus brefs délais.
      </p>
      <p ref={errorMessage} className="error-message display-none">
        Il semble qu'il y ait une erreur dans les informations que vous avez
        fournis.
        <br />
        Veuillez réessayer.
      </p>
