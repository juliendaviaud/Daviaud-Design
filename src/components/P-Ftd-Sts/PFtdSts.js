...
const PFtdSts = () => {
  ...
  const solutionText =
    ...
    const lightboxPhotos = [
      {
        src: "../../assets/images/ftd-sts/ftd-sts-full-main-page.png",
  ...
  const childProps = {
    coloredMainTitle: "Aéronautique",
    mainTitle: "FTD-STS",
    isThereAVideo: false,
    presentationVideo: qwesteoVideo,
    presentationImage: "../../assets/images/ftd-sts/project-details-main-image.png",
    clientName: "Qwesteo",
    technologies: [
      "Figma",
      "Photoshop",
