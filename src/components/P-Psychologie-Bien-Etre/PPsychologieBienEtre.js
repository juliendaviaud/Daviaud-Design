...
const PPsychologieBienEtre = () => {
  ...
  const lightboxPhotos = [
    {
      src: "../../assets/images/psychologie-bien-etre/psychologie-bien-etre-full-main-page.png",
      title: "Page principale",
      description: "Page principale",
      column: 1,
    },
    {
      src: "../../assets/images/psychologie-bien-etre/psychologie-bien-etre-full-eft-page.png",
      title: "EFT",
      description: "EFT",
      column: 1,
    },
    {
      src: "../../assets/images/psychologie-bien-etre/psychologie-bien-etre-full-psychologie-positive-page.png",
      title: "Psychologie positive",
      description: "Psychologie positive",
      column: 2,
    },
    {
      src: "../../assets/images/psychologie-bien-etre/psychologie-bien-etre-full-hypnose-page.png",
      title: "Hypnose",
      description: "Hypnose",
      column: 2,
    },
    {
      src: "../../assets/images/psychologie-bien-etre/psychologie-bien-etre-full-emdr+-page.png",
      title: "EMDR+",
      description: "EMDR+",
      column: 2,
    },
  ...
  const childProps = {
    coloredMainTitle: "Psychologue",
    mainTitle: "Sylvie Demaille",
    isThereAVideo: false,
    presentationVideo: qwesteoVideo,
    presentationImage: "../../assets/images/psychologie-bien-etre/project-details-main-image.png",
    clientName: "Qwesteo",
    technologies: [
      "Figma",
      "Photoshop",
...
export default PPsychologieBienEtre;
