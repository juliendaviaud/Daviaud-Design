...
const PMarieDupont = () => {
  ...
  const lightboxPhotos = [
    {
      src: "../../assets/images/marie-dupont/marie-dupont-full-main-page.png",
      title: "Page principale",
      description: "Page principale",
      column: 1,
    },
    {
      src: "../../assets/images/marie-dupont/marie-dupont-full-therapy-page.png",
      title: "Page de connexion",
      description: "Page de thérapies",
      column: 2,
    },
    {
      src: "../../assets/images/marie-dupont/marie-dupont-full-contact-page.png",
  ...
  const childProps = {
    ...
    mainTitle: "Marie Dupont",
    isThereAVideo: false,
    presentationVideo: qwesteoVideo,
    presentationImage: "../../assets/images/marie-dupont/project-details-main-image.png",
    clientName: "Qwesteo",
    technologies: [
      "Figma",
      "Photoshop",
