...
const PIntendancePenates = () => {
  ...
  const solutionText =
    ...
    const lightboxPhotos = [
      {
        src: "../../assets/images/intendance-penates/intendance-penates-full-main-page.png",
        title: "Page principale",
        description: "Page principale",
        column: 1,
      },
      {
        src: "../../assets/images/intendance-penates/intendance-penates-full-contact-page.png",
  ...
  const childProps = {
    coloredMainTitle: "Intendance",
    mainTitle: "Intendance Pénates",
    isThereAVideo: false,
    presentationVideo: qwesteoVideo,
    presentationImage: "../../assets/images/intendance-penates/project-details-main-image.png",
    clientName: "Qwesteo",
    technologies: [
      "Figma",
      "Photoshop",
...
export default PIntendancePenates;
