...
const PCindyDupres = () => {
  ...
  const solutionText =
    ...
    const lightboxPhotos = [
      {
        src: "../../assets/images/cindy-dupres/cindy-dupres-full-main-page.png",
        title: "Page principale",
        description: "Page principale",
        column: 1,
      },
      {
        src: "../../assets/images/cindy-dupres/cindy-dupres-full-therapy-page.png",
        title: "Page de connexion",
        description: "Page de thérapies",
        column: 2,
      },
      {
        src: "../../assets/images/cindy-dupres/cindy-dupres-full-contact-page.png",
  ...
  const childProps = {
    ...
    mainTitle: "Cindy Duprés",
    isThereAVideo: false,
    presentationVideo: qwesteoVideo,
    presentationImage: "../../assets/images/cindy-dupres/project-details-main-image.png",
    clientName: "Qwesteo",
    technologies: [
      "Figma",
      "Photoshop",
